...
namespace rentManagement
{
    public class RentManagementSystem
    {
    ...
    
        {
            ...
            //_tenantsList = new List<Tenant>();            <= before composition
            // _tenantStorageList = new TenantStorageListList();    <= before injection
        ...
        //public List<Tenant> _tenantsList { get; private set; }  <= before composition
